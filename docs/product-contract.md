...
current `semantic-atlas@2.1.3` release adds reviewed maintenance outcomes and
the narrow orchestration-status contract while accepting only current managed
Skill, observation, and claim contracts.
